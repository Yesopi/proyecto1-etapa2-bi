...
@web_bp.route('/clasificar', methods=['GET', 'POST'])
def clasificar():
    """Página unificada para clasificar noticias (individual o CSV)"""
    if request.method == 'POST':
        # Determinar tipo de solicitud basándose en el contenido del formulario
        es_csv = 'csv_file' in request.files and request.files['csv_file'].filename != ''
        ...
        if es_csv:
            ...
            # Hacer petición a nuestra propia API para procesar el CSV
            ...
            # PROCESAMIENTO DE NOTICIA INDIVIDUAL
            ...
            # Hacer petición a nuestra propia API para una noticia individual
    ...
    # Determinar qué plantilla mostrar basado en el parámetro 'mode'
